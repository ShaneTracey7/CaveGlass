    ...
    if (isMobile)
      ...
      { 
        display = <div className='goal-replay-container'>
                    ...
                    <iframe className='goal-replay-iframe' src="https://players.brightcove.net/6415718365001/D3UCGynRWU_default/index.html?videoId=6367913132112" allow="accelerometer; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                  </div> 
      }
